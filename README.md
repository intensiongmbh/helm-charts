...
| `realmCreator.options`           | Specify how the realms should be created. It contains the JSON as YAML in a string. See [keycloak-config-cli](https://github.com/adorsys/keycloak-config-cli) for more information | `""`                          |
